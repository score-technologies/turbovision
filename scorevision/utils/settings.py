...
class Settings(BaseModel):
    ...
    PRIVATE_RESPONSES_R2_BUCKET: str
    ...
    PRIVATE_SPOTCHECK_API_URL: str
    PRIVATE_FRAME_RATE: int
    PRIVATE_MIN_ACTIONS_FOR_CHALLENGE: int
    PRIVATE_AUDIT_SPOTCHECK_MIN_INTERVAL_S: int
    PRIVATE_AUDIT_SPOTCHECK_MAX_INTERVAL_S: int
    PRIVATE_MINER_RESPONSES_API_URL: str
    PRIVATE_BENCHMARK_R2_PREFIX: str
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        SCOREVISION_WINDOW_K_PER_VALIDATOR=int(
            getenv("SCOREVISION_WINDOW_K_PER_VALIDATOR", 10)
        ),
        SCOREVISION_WINDOW_DELTA_ABS=float(
        ...
        PRIVATE_RESPONSES_R2_BUCKET=getenv("PRIVATE_RESPONSES_R2_BUCKET", ""),
        ...
        BLACKLIST_API_URL=getenv("BLACKLIST_API_URL", ""),
        PRIVATE_SPOTCHECK_API_URL=getenv("PRIVATE_SPOTCHECK_API_URL", ""),
        ...
        PRIVATE_AUDIT_SPOTCHECK_MIN_INTERVAL_S=int(getenv("PRIVATE_AUDIT_SPOTCHECK_MIN_INTERVAL_S", 172800)),
        PRIVATE_AUDIT_SPOTCHECK_MAX_INTERVAL_S=int(getenv("PRIVATE_AUDIT_SPOTCHECK_MAX_INTERVAL_S", 259200)),
        PRIVATE_MINER_RESPONSES_API_URL=getenv("PRIVATE_MINER_RESPONSES_API_URL", ""),
        PRIVATE_BENCHMARK_R2_PREFIX=getenv("PRIVATE_BENCHMARK_R2_PREFIX", "private_benchmark"),
        # Benchmark
        BENCHMARK_VERSION=int(getenv("BENCHMARK_VERSION", 1)),
        ...
        CHECKER_OUTPUT_DRIFT_MIN_MATCHED_IOU=float(getenv("CHECKER_OUTPUT_DRIFT_MIN_MATCHED_IOU", 0.95)),
