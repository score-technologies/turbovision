...
class GroundTruth(BaseModel):
    ...
    url:str
    annotations:list[PsuedoGroundTruth]
...
def load_ground_truth_dataset() -> list[GroundTruth]:
    gts =  []
    for _ in range(10):
